...
#   Greeks. Those source values carry six decimal places, so most are stored as
#   Decimal32(6): fixed-point 4-byte integers scaled by 1,000,000. Theta uses
#   Decimal64(6) because recent years contain values outside Decimal32(6)'s
#   +/-2147.483647 range. This keeps the WRDS six-decimal values exact while
#   removing Float32 mantissa noise that compresses poorly. The loader validates
#   each decimal column's target range at the chunk boundary before insertion.
